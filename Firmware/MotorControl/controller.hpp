...
public:
    ...
    float write_anticogging_map(uint16_t index, float value);
    ...
    auto make_protocol_definitions() {
        return make_protocol_member_list(
            ...
            make_protocol_object("anticogging",
                make_protocol_property("index", &anticogging_.index),
                // make_protocol_property("cogging_map", &anticogging_.cogging_map),
                make_protocol_function("write_anticogging_map", *this, &Controller::write_anticogging_map, "index", "value"),
